    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Lables", x => x.Key);
                    table.ForeignKey(
                        name: "FK_Lables_Images_LogoKey",
                        column: x => x.LogoKey,
                        principalTable: "Images",
                        principalColumn: "Key");
                    table.ForeignKey(
                        name: "FK_Lables_Makers_MakerKey",
                        column: x => x.MakerKey,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Key");
                    table.ForeignKey(
                        name: "FK_Movies_Lables_LabelKey",
                        column: x => x.LabelKey,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShortTexts_Lables_LabelKey",
                        column: x => x.LabelKey,
                        principalTable: "Lables",
                        principalColumn: "Key");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lables_LogoKey",
                table: "Lables",
                column: "LogoKey");

            migrationBuilder.CreateIndex(
                name: "IX_Lables_MakerKey",
                table: "Lables",
                column: "MakerKey");
